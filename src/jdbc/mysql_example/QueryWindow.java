...
public class QueryWindow {
	...
	private static void InitTextFields(){
		...
		mDatabaseCB = new JComboBox(new String[]{"jdbc:mysql://localhost:3306/dbookcom_db"});
		...
		mConnectButton.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				if(!mUsernameTF.getText().isEmpty() ){
					mDBEngine = new DBEngine("jdbc:mysql://localhost:3306/dbookcom_db",mUsernameTF.getText(),mPasswordTF.getText());
					...
					if(mDBEngine.getConnection() != null){
						mConnectionL.setText("jdbc:mysql://localhost:3306/dbookcom_db");
